  ...
  return (
    <div className="relative" ref={menuRef}>
      <button
        ...
        className="flex items-center gap-2 px-3 py-1.5 rounded-xl border border-[rgba(255,255,255,0.06)] bg-[rgba(15,15,22,0.6)] text-[#a0a0b8] hover:text-white hover:border-[rgba(251,78,11,0.3)] transition-all cursor-pointer text-sm"
      >
        <div className="w-6 h-6 rounded-full bg-gradient-to-br from-[#fb4e0b] to-[#ff814d] flex items-center justify-center text-white font-bold text-xs">
